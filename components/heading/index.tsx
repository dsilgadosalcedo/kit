...
interface DdssHeadingProps extends React.HTMLAttributes<HTMLHeadingElement> {
  tag?: DdssHeadingTag;
  fontClass?: string; // Should be DdssFontClass in production
...
export default function Heading({
  ...
  return (
    <Tag data-ddss-component="heading" className={`${fontClass} color-${fontColor} ${className || ""}`} {...headingAttrs}>
      {children}
    </Tag>
  );
}
