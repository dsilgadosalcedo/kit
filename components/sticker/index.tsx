...
/**
 * Props for the DdssSticker component.
 * 
 ...
 */
interface DdssStickerProps extends React.HTMLAttributes<HTMLDivElement> {
  fontClass?: DdssFontClass;
  bgColor?: DdssColor; // supports all DdssColors instead of only those with on-token support
...
export default function Sticker({
  ...
  return (
    <div data-ddss-component="sticker" {...restProps} className={`bg-${bgColor} color-${getOnToken(bgColor)} ${className || ""}`}>
