...
interface DdssTabMenuProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'onClick'> {
  tabLinks?: string[];
...
export default function TabMenu(props: DdssTabMenuProps) {
  const {
...
/**Don't include tabLinks or setActiveTab props in the useMemo hook, because they don't affect CSS. */
  ...
  return (
    <div data-ddss-component="tab-menu" {...dataAttrs} {...restProps}>
