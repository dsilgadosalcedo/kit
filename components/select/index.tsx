...
export interface DdssSelectTriggerProps {
  children: React.ReactElement;
}

export interface DdssSelectMenuProps {
  children: React.ReactNode;
  cardProps?: DdssCardProps;
}

export interface DdssSelectOptionProps {
  value: string;
  children: React.ReactNode;
  onClick?: () => void;
...
const SelectContext = createContext<DdssSelectContext>({} as DdssSelectContext);
...
export function SelectTrigger({ children }: DdssSelectTriggerProps) {
...
export function SelectMenu({ children, cardProps }: DdssSelectMenuProps) {
  ...
  return ReactDOM.createPortal(
    <div
      ...
      role="menu"
      data-ddss-component="select-menu"
      data-isactive={open}
    >
...
export function SelectOption({ value, children, onClick, startIcon, endIcon }: DdssSelectOptionProps) {
