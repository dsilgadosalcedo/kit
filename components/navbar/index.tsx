...
interface DdssNavBarProps extends React.HTMLAttributes<HTMLDivElement> {
  material?: DdssMaterial;
...
export default function NavBar({
  ...
  return (
    <div data-ddss-component="navbar" {...dataAttrs}>
      {/* Desktop Navbar */}
      <div className="navbar-desktop">
        ...
        <Row>
          <Row data-ddss-slot="nav-buttons">{navButtons || getPlaceholderBlocks(2)}</Row>
          <Row data-ddss-slot="nav-dropdowns">{navDropdowns || getPlaceholderBlocks(2) }</Row>
        </Row>
        <Row data-ddss-navbar-el="nav-menu-end">
          <div data-ddss-slot="nav-icon-buttons">{iconButtons || getPlaceholderBlocks(3)}</div>
          <div data-ddss-slot="nav-cta-buttons">{ctaButtons || getPlaceholderBlocks(2)}</div>
        </Row>
      </div>

      {/* Mobile Navbar */}
      <div data-ddss-navbar-el="nav-menu">
