...
declare global {
   ...
   * As it increases from 'md,' each step multiplies the previous size by var(--ddss-scalefactor).
   * As it decreases from 'md,' each step divides the previous size by var(--ddss-scalefactor).
   ...
   */
  type DdssContainerWidth = "xs" | "sm" | "md" | "lg" | "xl" | "none" | "auto";
}
